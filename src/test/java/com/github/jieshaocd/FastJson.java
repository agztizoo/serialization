...
import com.github.jieshaocd.fastjson.FastjsonDeserialize;
import com.github.jieshaocd.fastjson.FastjsonSerialize;
...
public class FastJson {
    ...
    private static ISerialize<App> ser = new FastjsonSerialize();

    private static IDeserialize<App> deser = new FastjsonDeserialize();
